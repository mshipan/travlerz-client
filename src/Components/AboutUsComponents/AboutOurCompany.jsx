    ...
    <div className="container mx-auto my-20 px-2 md:px-0">
      <div className="flex flex-col md:flex-row items-center gap-5">
        ...
        <div className="max-w-2xl">
          <h1 className="text-3xl font-barlow font-bold mb-5 text-center md:text-left">
          ...
          <div className="flex flex-col md:grid md:grid-cols-1 justify-center gap-5 mb-5">
            <div className="flex items-center justify-center gap-5">
              <div className="flex flex-col items-center gap-1 p-5 hover:text-red-500 shadow-lg duration-300">
                <h1 className="font-barlow font-extrabold text-3xl ">
                  {packages.length}+
                </h1>
                <h5 className="font-barlow font-semibold md:text-lg ">
                  Awesome Tour
                </h5>
              </div>
              <div className="flex flex-col items-center gap-1 p-5 hover:text-red-500 shadow-lg duration-300">
          ...
          <p className="font-barlow text-center md:text-left">
